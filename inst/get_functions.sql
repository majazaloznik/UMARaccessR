-- ============================================================================
-- Function definition get_all_series_wtable_names
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.get_dimensions_from_table_id(p_table_id bigint)
RETURNS TABLE (
    id bigint,
    table_id bigint,
    dimension character varying,
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.get_series_from_table_id(p_table_id bigint)
RETURNS TABLE (
   id bigint,
   table_id bigint,
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.get_series_ids_from_table_id(p_table_id bigint)
RETURNS TABLE (id bigint) AS $$
BEGIN
   RETURN QUERY
   SELECT s.id
...
-- ============================================================================
CREATE OR REPLACE FUNCTION platform.get_vintages_with_hashes_for_series(
    p_series_id BIGINT
)
RETURNS TABLE (
    id BIGINT,
